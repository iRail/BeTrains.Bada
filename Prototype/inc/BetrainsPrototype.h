#ifndef _BETRAINSPROTOTYPE2_H_
#define _BETRAINSPROTOTYPE2_H_
...
/**
 * [BetrainsPrototype2] application must inherit from Application class
 * which provides basic features necessary to define an application.
 */
class BetrainsPrototype :
...
public:
	...
	~BetrainsPrototype();
	/**
	 * [BetrainsPrototype2] application must have a factory method that creates an instance of itself.
	 */
	static Osp::App::Application* CreateInstance(void);

	void showMenu(void);

	void showRoutePlanner(void);
